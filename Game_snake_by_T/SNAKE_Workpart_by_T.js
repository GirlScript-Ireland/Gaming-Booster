...
function setup() {
  bg = loadImage('backgrndforsnake.png'); //load the background, always remember to add it into the sketch first
  createCanvas(1000 , 600); //create canvas according to the browser window size
